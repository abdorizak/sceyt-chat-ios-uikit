//
//  PollResultsViewController+QuestionCell+Appearance.swift
//  SceytChatUIKit
//
...
extension PollResultsViewController.QuestionCell: AppearanceProviding {
    ...
    public struct Appearance {
        ...
        public var questionLabelAppearance: LabelAppearance
        ...
        public init(
            ...
            borderWidth: CGFloat,
            borderColor: UIColor,
            questionLabelAppearance: LabelAppearance
        ) {
            ...
            self._questionLabelAppearance = Trackable(value: questionLabelAppearance)
        }

        public init(
            reference: PollResultsViewController.QuestionCell.Appearance,
            backgroundColor: UIColor? = nil,
            containerBackgroundColor: UIColor? = nil,
            cornerRadius: CGFloat? = nil,
            borderWidth: CGFloat? = nil,
            borderColor: UIColor? = nil,
            questionLabelAppearance: LabelAppearance? = nil
        ) {
            ...
            self._questionLabelAppearance = Trackable(reference: reference, referencePath: \.questionLabelAppearance)
            ...
            if let questionLabelAppearance {
                self.questionLabelAppearance = questionLabelAppearance
            }
        }
    }
}
