...
extension CreatePollViewController: AppearanceProviding {
    public static var appearance = Appearance(
        ...
        titleText: L10n.Poll.title,
        questionDescriptionText: L10n.Poll.Question.header,
        optionsHeaderText: L10n.Poll.Options.header,
        parametersHeaderText: L10n.Poll.Parameters.header,
        questionPlaceholderText: L10n.Poll.Question.placeholder,
        optionPlaceholderText: { _ in L10n.Poll.Option.placeholder },
        addOptionText: L10n.Poll.Option.add,
        allowMultipleAnswersText: L10n.Poll.multipleVotes,
        showVoterNamesText: L10n.Poll.anonymousPoll,
        allowAddingOptionsText: L10n.Poll.cantRetractVotes,
        cancelText: L10n.Poll.Button.cancel,
        createText: L10n.Poll.Button.send,
        discardAlertTitle: nil,
        discardAlertMessage: L10n.Poll.Discard.Alert.message,
        discardAlertCancelText: L10n.Poll.Discard.Alert.keepEditing,
        discardAlertDiscardText: L10n.Poll.Discard.Alert.discard,
        maxOptionsCount: 12
    )
