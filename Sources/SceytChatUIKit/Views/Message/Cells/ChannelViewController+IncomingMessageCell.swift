...
extension ChannelViewController {
    open class IncomingMessageCell: MessageCell {
        ...
        open override func layoutConstraints(layout: MessageLayoutModel) -> [NSLayoutConstraint] {
            ...
            if options == .text {
                ...
                layoutConstraint += [
                    ...
                    unsupportedView.topAnchor.pin(to: contentTopAnchor, constant: 4.0),
                    unsupportedView.trailingAnchor.pin(to: bubbleView.trailingAnchor),
                    unsupportedView.bottomAnchor.pin(to: infoView.topAnchor),

                    infoView.topAnchor.pin(to: bubbleView.bottomAnchor, constant: -24.0)
                ]
        ...
        open override class func measure(
            ...
            if options == .text {
            ...
            } else if options.contains(.unsupported) {
                ...
                let effectiveTextSize = shouldDisplayReadMoreButton ? model.truncatedTextSize : model.textSize
                bubbleSize.height += (effectiveTextSize.height > 0 && model.showUserInfo) ? 8 : 2
