...
extension SceytChatUIKit {
    public enum Components {
        ...
        public static var channelAddMembersViewModel: ChannelAddMembersViewModel.Type = ChannelAddMembersViewModel.self
        ...
        public static var userReactionViewModel: UserReactionViewModel.Type = UserReactionViewModel.self
