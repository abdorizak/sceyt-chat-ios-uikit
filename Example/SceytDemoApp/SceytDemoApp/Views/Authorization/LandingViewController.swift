...
class LandingViewController: ViewController {
    ...
    lazy var createButton = {
        ...
        $0.setTitleColor(SceytChatUIKit.shared.theme.colors.onPrimary, for: .normal)
        $0.titleLabel?.font = .systemFont(ofSize: .init(17), weight: .semibold)
        $0.backgroundColor = SceytChatUIKit.shared.theme.colors.accent
    ...
    lazy var chooseButton = {
        ...
        $0.setTitleColor(SceytChatUIKit.shared.theme.colors.accent, for: .normal)
        $0.titleLabel?.font = .systemFont(ofSize: .init(17), weight: .semibold)
